 ...
 * @export
 */
exports.HealthchecksApiAxiosParamCreator = function (configuration) {
    var _this = this;
    return {
        /**
         *
 ...
 * @export
 */
exports.HealthchecksApiFp = function (configuration) {
    return {
        /**
         *
         * @param {*} [options] Override http request option.
 ...
 * @export
 */
exports.HealthchecksApiFactory = function (configuration, basePath, axios) {
    return {
        /**
         *
         * @param {*} [options] Override http request option.
